...
def test_swap_best_by_category():
    ...
    assert tai.inventory == tai.inventory
    assert jesse.inventory == jesse.inventory
    # *********************************************************************
    # ****** Complete Assert Portion of this test **********
    # *********************************************************************
...
def test_swap_best_by_category_reordered():
    ...
    assert [item_f, item_e, item_d] != tai.inventory 
    assert [item_c, item_b, item_a] != jesse.inventory
    # *********************************************************************
    # ****** Complete Assert Portion of this test **********
    # *********************************************************************
    # Assertions should check:
