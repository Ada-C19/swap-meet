...
def test_swap_best_by_category():
    ...
    assert item_d.get_category() ==  "Clothing" and item_f.get_category() == "Clothing" and item_e.get_category() != "Clothing"
    assert item_f.condition > item_d.condition

    assert item_a in tai.inventory 
    assert item_b in tai.inventory
    assert item_f in tai.inventory

    assert item_a.get_category() == "Decor" and item_c.get_category() == "Decor" and item_b.get_category != "Decor"
    assert item_c.condition > item_a.condition 
...
def test_swap_best_by_category_no_match_is_false():
    ...
    assert item_a.get_category() != "Clothing" and item_b.get_category() != "Clothing" and item_c.get_category() != "Clothing"
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    assert item_d.get_category() != "Electronics" and item_e.get_category() != "Electronics" and item_f.get_category() !="Electronics"