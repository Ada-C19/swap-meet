...
def test_swap_best_by_category():
    ...
    assert jesse.get_best_by_category("Decor").condition == 4.0
    assert jesse.inventory == [item_d, item_e, item_c]
    assert len(tai.inventory) == 3
    assert tai.get_best_by_category("Clothing").condition == 4.0
    assert tai.inventory == [item_a, item_b, item_f]
    # their (jesse) item_f should be in my inventory, clothing with condition 4
    # my (tai) item_c should be in their inventory, decor with condition 4
    # *********************************************************************
    # ****** Complete Assert Portion of this test **********
    # *********************************************************************
...
def test_swap_by_newest():
    ...
    assert len(tai.inventory) == 3
    assert tai.inventory == [item_b, item_c, item_f]

def test_swap_by_newest_by_category_no_inventory_is_false():
    # Arrange
    # me
    item_a = Decor(age=1.0)
    item_b = Electronics(age=4.0)
