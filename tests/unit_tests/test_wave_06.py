...
def test_swap_best_by_category_no_match_is_false():
    ...
    #assert not result, "Expected swap_best_by_category() to return falsy value."
    ...
    assert len(jesse.inventory) == 3, "Expected tai's inventory to have 3 items."
    assert item_d in jesse.inventory, "Expected item_d to be in tai's inventory."
    assert item_e in jesse.inventory, "Expected item_e to be in tai's inventory."
    assert item_f in jesse.inventory, "Expected item_f to be in tai's inventory."
#@pytest.mark.skip
def test_swap_best_by_category_no_other_match_is_false():
    ...
    assert item_a in jesse.inventory, "Expected item_a to be added to jesse's inventory"
    assert item_b in tai.inventory, "Expected item_a to remain from tai's inventory"

    assert item_c in jesse.inventory, "Expected item_a to be added to jesse's inventory"
    assert item_d in jesse.inventory, "Expected item_a to be added to tai's inventory"
    assert item_e in jesse.inventory, "Expected item_a to be added to jesse's inventory"