class Vendor:
    ...
    def swap_first_item(self, other_vendor):
        try:
            ...
            return False
        first_item_switch = self.swap_items(
            other_vendor, my_first_item, their_first_item)
        return first_item_switch

    # returns list of items that are a specific category
    ...
    #swapping item from each vendor's desired category and the item that has best condtion
