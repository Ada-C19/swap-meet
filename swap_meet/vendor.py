class Vendor:
    ...
    def swap_best_by_category(self, other_vendor, my_priority, their_priority):
        if len(self.get_by_category(their_priority)) == 0 or len(other_vendor.get_by_category(my_priority)) == 0:
            return False
    ...
    def swap_by_newest(self, other_vendor):
        ...
        their_newest, their_age = other_vendor.inventory[0], other_vendor.inventory[0].age
